...
<head>
    ...
    <style>
        ...
        p {
            margin-top: 90px;
            margin-bottom: 20px; /* Reduzi a margem inferior do parágrafo */
        }   
        a.voltar {
            color: #fff;
            ...
            border-radius: 20px;
            margin-top: 20px; /* Adicionei uma margem superior ao botão */
...
<body>
    <?php
    $angulo = $_GET["angulo1"];
    echo "<Strong><p> O cosseno do ângulo é: " . cos($angulo) . "</p>";
    ?>
